"""Updated main game: VikusGame with goku image in the centre"""
"""blue sky main module."""
import pygame
import sys

from tiy_12_2 import Goku
...
class VikusGame:
    ...
    def run_game(self):
        ...
        while True:
            ...
            # adding character image after filling background
